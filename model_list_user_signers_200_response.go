...
func (o *ListUserSigners200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListUserSigners200Response := _ListUserSigners200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListUserSigners200Response)

	if err != nil {
		return err
	}

	*o = ListUserSigners200Response(varListUserSigners200Response)
