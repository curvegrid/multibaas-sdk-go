...
func (o *CallContractFunction200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCallContractFunction200Response := _CallContractFunction200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCallContractFunction200Response)

	if err != nil {
		return err
	}

	*o = CallContractFunction200Response(varCallContractFunction200Response)
