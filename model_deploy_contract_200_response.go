...
// checks if the DeployContract200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeployContract200Response{}
...
func NewDeployContract200Response(status int64, message string, result DeployContractTransaction) *DeployContract200Response {
	this := DeployContract200Response{}
	this.Status = status
...
func (o *DeployContract200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeployContract200Response := _DeployContract200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeployContract200Response)

	if err != nil {
		return err
	}

	*o = DeployContract200Response(varDeployContract200Response)

	return err
}

type NullableDeployContract200Response struct {
	value *DeployContract200Response
	isSet bool
}
...
func NewNullableDeployContract200Response(val *DeployContract200Response) *NullableDeployContract200Response {
	return &NullableDeployContract200Response{value: val, isSet: true}
}
