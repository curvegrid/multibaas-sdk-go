...
func (o *EIP712TypeEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varEIP712TypeEntry := _EIP712TypeEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEIP712TypeEntry)

	if err != nil {
		return err
	}

	*o = EIP712TypeEntry(varEIP712TypeEntry)
