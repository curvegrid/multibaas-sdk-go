...
func (o *CountEventQueryRecords200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCountEventQueryRecords200Response := _CountEventQueryRecords200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCountEventQueryRecords200Response)

	if err != nil {
		return err
	}

	*o = CountEventQueryRecords200Response(varCountEventQueryRecords200Response)
