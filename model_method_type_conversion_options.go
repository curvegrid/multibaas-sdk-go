...
func (o *MethodTypeConversionOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varMethodTypeConversionOptions := _MethodTypeConversionOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMethodTypeConversionOptions)

	if err != nil {
		return err
	}

	*o = MethodTypeConversionOptions(varMethodTypeConversionOptions)
