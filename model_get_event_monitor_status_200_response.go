...
// checks if the GetEventMonitorStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEventMonitorStatus200Response{}
...
type _GetEventMonitorStatus200Response GetEventMonitorStatus200Response
...
func NewGetEventMonitorStatus200Response(status int64, message string, result EventMonitorStatus) *GetEventMonitorStatus200Response {
	this := GetEventMonitorStatus200Response{}
	this.Status = status
...
func (o *GetEventMonitorStatus200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEventMonitorStatus200Response := _GetEventMonitorStatus200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEventMonitorStatus200Response)

	if err != nil {
		return err
	}

	*o = GetEventMonitorStatus200Response(varGetEventMonitorStatus200Response)

	return err
}

type NullableGetEventMonitorStatus200Response struct {
	value *GetEventMonitorStatus200Response
	isSet bool
}
...
func NewNullableGetEventMonitorStatus200Response(val *GetEventMonitorStatus200Response) *NullableGetEventMonitorStatus200Response {
	return &NullableGetEventMonitorStatus200Response{value: val, isSet: true}
}
