...
func (o *HSMSignRequestPersonalSign) UnmarshalJSON(data []byte) (err error) {
	...
	varHSMSignRequestPersonalSign := _HSMSignRequestPersonalSign{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHSMSignRequestPersonalSign)

	if err != nil {
		return err
	}

	*o = HSMSignRequestPersonalSign(varHSMSignRequestPersonalSign)
