...
type _GetEventCount200Response GetEventCount200Response
...
func (o *GetEventCount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEventCount200Response := _GetEventCount200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEventCount200Response)

	if err != nil {
		return err
	}

	*o = GetEventCount200Response(varGetEventCount200Response)
