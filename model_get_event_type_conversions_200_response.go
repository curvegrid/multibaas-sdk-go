...
// checks if the GetEventTypeConversions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEventTypeConversions200Response{}
...
type _GetEventTypeConversions200Response GetEventTypeConversions200Response
...
func NewGetEventTypeConversions200Response(status int64, message string, result EventTypeConversionOptions) *GetEventTypeConversions200Response {
	this := GetEventTypeConversions200Response{}
	this.Status = status
...
func (o *GetEventTypeConversions200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEventTypeConversions200Response := _GetEventTypeConversions200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEventTypeConversions200Response)

	if err != nil {
		return err
	}

	*o = GetEventTypeConversions200Response(varGetEventTypeConversions200Response)

	return err
}

type NullableGetEventTypeConversions200Response struct {
	value *GetEventTypeConversions200Response
	isSet bool
}
...
func NewNullableGetEventTypeConversions200Response(val *GetEventTypeConversions200Response) *NullableGetEventTypeConversions200Response {
	return &NullableGetEventTypeConversions200Response{value: val, isSet: true}
}
