...
type _EventInformation EventInformation
...
func (o *EventInformation) UnmarshalJSON(data []byte) (err error) {
	...
	varEventInformation := _EventInformation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEventInformation)

	if err != nil {
		return err
	}

	*o = EventInformation(varEventInformation)
