...
// checks if the GetContractVersions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContractVersions200Response{}
...
type _GetContractVersions200Response GetContractVersions200Response
...
func NewGetContractVersions200Response(status int64, message string, result []Contract) *GetContractVersions200Response {
	this := GetContractVersions200Response{}
	this.Status = status
...
func (o *GetContractVersions200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetContractVersions200Response := _GetContractVersions200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetContractVersions200Response)

	if err != nil {
		return err
	}

	*o = GetContractVersions200Response(varGetContractVersions200Response)

	return err
}

type NullableGetContractVersions200Response struct {
	value *GetContractVersions200Response
	isSet bool
}
...
func NewNullableGetContractVersions200Response(val *GetContractVersions200Response) *NullableGetContractVersions200Response {
	return &NullableGetContractVersions200Response{value: val, isSet: true}
}
