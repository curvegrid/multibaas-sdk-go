...
func (o *ListHsmWallets200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListHsmWallets200Response := _ListHsmWallets200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListHsmWallets200Response)

	if err != nil {
		return err
	}

	*o = ListHsmWallets200Response(varListHsmWallets200Response)
